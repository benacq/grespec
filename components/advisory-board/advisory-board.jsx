...
function AdvisoryBoard() {
  return (
    <section className="responsive py-10">
      ...
      <div className="mt-10 flex justify-center gap-10 min-h-px-350">
        <div className="w-1/3">
          <div
            className={
              "bg-[url('/agribusiness.png')] h-3/4 w-full bg-cover bg-center bg-no-repeat"
            }
          />
      ...
      <div className="mt-10 flex justify-between gap-10 min-h-px-350">
        <div className="w-1/3">
          <div
            className={`bg-[url('/agribusiness.png')] h-3/4 w-full bg-cover bg-center bg-no-repeat`}
          />
